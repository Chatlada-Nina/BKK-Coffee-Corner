"""
Django settings for coffeecorner project.
...
# Add constants to allow template pack
...
ROOT_URLCONF = 'coffeecorner.urls'
...
WSGI_APPLICATION = 'coffeecorner.wsgi.application'
...
# Ensure the only requests allowed are ones originating from hosts in the list.
